...
const Slider = () => {
  ...
  return (
    <div className="h-full w-14 p-2 flex fixed top-0 left-0 flex-col items-center bg-[#272727] text-2xl justify-around shadow-2xl shadow-black transition-all duration-300 transform -translate-x-10 hover:translate-x-0">
